...
<head><!-- Basic -->
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="/storage/img/cv-et-cv.png" type="image/x-icon">
    ...
    <!-- Head Libs -->
    <script src="/resources/Porto/vendor/modernizr/modernizr.min.js"></script>
</head>
<body data-plugin-page-transition="">
<div class="body">
    <header id="header" class="header-effect-shrink" data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': false, 'stickyChangeLogo': true, 'stickyStartAt': 30, 'stickyHeaderContainerHeight': 70}" style="height: 100.8px;">
        <div class="header-body border-top-0" style="">
            <div class="header-container container container-xl-custom" style="height: 100px;">
                <div class="header-row">
                    <div class="header-column">
                        <div class="header-row">
                            <div class="header-logo" style="width: 82px; height: 40px;">
                                <a href="/">
                                    <img src="/storage/img/developpement-web.png" href="/" alt="icon" title="Home">
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row py-5">
            <div class="col text-center">
                <ul class="footer-social-icons social-icons social-icons-clean social-icons-big social-icons-opacity-light social-icons-icon-light mt-1">
                    <li class="social-icons-youtube"><a href="https://www.youtube.com/channel/UCzQIatR65RnjZfkfaWRsQhw" target="_blank" title="Youtube"><i class="fab fa-youtube text-2 m-3"></i></a></li>
                    <li class="social-icons-clean-with-border"><a href="https://github.com/itemka120" target="_blank" title="GitHub"><i class="fab fa-github text-2 m-3"></i></a></li>
                    <li class="social-icons-linkedin"><a href="https://steamcommunity.com/id/itemka/" target="_blank" title="Steam"><i class="fab fa-steam text-2 m-3"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container container-xl-custom py-2">
            <div class="row py-4">
                <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                    <p>
                        <span class="pe-0 pe-md-3 d-block d-md-inline-block"><i class="far fa-dot-circle text-color-primary top-1 p-relative"></i><span class="text-color-light opacity-7 ps-1">3 Rue du Centre, Serignan du comtat</span></span>
                        <span class="pe-0 pe-md-3 d-block d-md-inline-block"><i class="far fa-envelope text-color-primary top-1 p-relative"></i><a href="mailto:elizabedfrau39@gmail.com" class="text-color-light opacity-7 ps-1">elizabedfrau39@gmail.com</a></span>
                    </p>
                </div>
